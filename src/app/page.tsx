          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                ...
                UI/UX design student at the University of Ottawa. With
                extensive experience in modern web technologies, particularly
                Next.js, I&apos;m now expanding my expertise into user
                experience design and interface principles.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                intersection of solid engineering and thoughtful design. My
                goal is to bridge this gap and create products that users love
                and developers can build efficiently.
              </p>
            </div>
        ...
        <section id="projects" className="scroll-mt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4 max-w-2xl mx-auto">
              ...
              comprehensive design projects, each showcasing the intersection
              of technical implementation and user-centered design.
            </p>
          </div>
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="https://seg-3125-a2-three.vercel.app/">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                    A full-featured e-commerce platform with focus on
                    conversion optimization, built with Next.js and modern
                    payment integration.
                  </p>
                  <div className="flex items-center justify-between">
